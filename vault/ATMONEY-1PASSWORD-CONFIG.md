================================
ATMONEY credentials on Key Vault
================================
...
type KeystoreConfig struct {
	...
	// cache
	RedisHost     string `opitem:"ATMONEY_TRANSACTION_REDIS" opfield:"host"`
	RedisPort     string `opitem:"ATMONEY_TRANSACTION_REDIS" opfield:"port"`
	RedisPassword string `opitem:"ATMONEY_TRANSACTION_REDIS" opfield:"password"`
